sap.ui.define([
	...
	return {
		 ...
		 * @public
		 */
		showValueHelpDialog: function (that, f4h, data) {
			try {
				...
				that.vhDialog = showValueHelpToDialog(that, f4h, data);
			} catch (e) {
				handleException(e);
			}
		}
	 ...
	 * @public
	 */
	function showValueHelpToDialog(that, f4h, data) {
		try {
			...
			var oVhJsonModel = new JSONModel({
				...
				oValueHelpDialog = new ValueHelpDialog(that.createId("F4H"), {
			...
			oValueHelpDialog.getTable().setModel(oVhJsonModel);
