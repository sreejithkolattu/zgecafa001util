...
sap.ui.define(["sap/ui/core/Control", "sap/ui/model/json/JSONModel", "zgecafa001util/zgecafa001util/controls/FormUtility"], function (
	...
	return {
		 ...
		 * @public
		 */
		_setKeepInTouchFormData: function (that, oPersonalDataFlag, oPersonalData) {
			var oModel = new JSONModel({
				...
				"lblPersonalNumber": "Personnel Number",
				"lblPersonalEmailAddress": "Personal email address",
				"lblEmployeeName": "Officer name",
				"lblMobileNumber": "Mobile contact no",
			...
			handleFragmentView(that, oModel, "zgecafa001util.zgecafa001util.fragments.KeepInTouchForm");
			// handleFragmentView(that, oModel, "zgeexfa007.ZGEEXFA007.view.subview.KeepInTouchForm");
		},
		...
		_getKeepInTouchFormData: function (that) {
			...
			var oKeepInTouchFormData = that.getModel("keepInTouchFormModel"),
				oKeepInTouchFormPayload = {
					"RegularEmail": cbValueConversion(oKeepInTouchFormData.getProperty("/bRegularEmail")),
					...
					"Volunteer": cbValueConversion(oKeepInTouchFormData.getProperty("/bVolunteer")),
					"VolunteerCommunity8Hrs": cbValueConversion(oKeepInTouchFormData.getProperty("/bVolunteerCommunity8Hrs")),
					"VolunteerCommunity4Hrs": cbValueConversion(oKeepInTouchFormData.getProperty("/bVolunteerCommunity4Hrs")),
					"VolunteerCommunity2Hrs": cbValueConversion(oKeepInTouchFormData.getProperty("/bVolunteerCommunity2Hrs")),
					"VolunteerRehab2Hrs": cbValueConversion(oKeepInTouchFormData.getProperty("/bVolunteerRehab2Hrs")),
					"VolunteerRehabADhoc": cbValueConversion(oKeepInTouchFormData.getProperty("/bVolunteerRehabADhoc")),
					"VolunteerDrugsADhoc": cbValueConversion(oKeepInTouchFormData.getProperty("/bVolunteerDrugsADhoc")),
					"YesIContribute": cbValueConversion(oKeepInTouchFormData.getProperty("/bYesIContribute")),
					"FrontOperation": cbValueConversion(oKeepInTouchFormData.getProperty("/bFrontOperation")),
					"CommunicationPublicEngagement": cbValueConversion(oKeepInTouchFormData.getProperty("/bCommunicationPublicEngagement")),
					"Technology": cbValueConversion(oKeepInTouchFormData.getProperty("/bTechnology")),
					"EnforcementIntelligence": cbValueConversion(oKeepInTouchFormData.getProperty("/bEnforcementIntelligence")),
					"TrainingDevelopment": cbValueConversion(oKeepInTouchFormData.getProperty("/bTrainingDevelopment")),
					"Others": cbValueConversion(oKeepInTouchFormData.getProperty("/bOthers"))
				};
	 ...
	 */
	function cbEventHandler(that, oModel) {
	...
	/**
	 * Function : cbValueConversion (Convertion of "True" value to "X" & "False" value to "".)
	 * @param {function} sValue : Check-Box Value (True or False)
	 * @returns {string} sValue : Either "X" or "".
	 * @public
	 */
	function cbValueConversion(sValue) {
		if (sValue == true) {
			return "X";
