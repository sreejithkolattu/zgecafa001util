sap.ui.define(["jquery.sap.global", "sap/ui/core/Control"], function (jQuery, Control) {
	...
	function validateControl(oControl, cType) {
		...
		} else if (cType === "fgRadioButtonEntry" && isValidControl(oControl)) { // Checks : Selected index is 00 or undefined
			return (oControl.getSelected() === false );	
		} else if (cType === "fgRadioButtonGroupEntry" && isValidControl(oControl)) { // Checks : Selected index is 00 or undefined
