sap.ui.define(["jquery.sap.global", "sap/ui/core/Control"], function (jQuery, Control) {
	...
	return {
		...
		ValidateForm: function (that, formId) {
			...
			//Validation for all select/combo - Validate only Value not key
		...
		resetValidStates: function (that) {
			var fields = ["fgInput", "fgSelect", "fgDate", "fgEmail","fgSelectValue", "fgNumber", "fgMobile", "fgCheckBox", "fgMultiSelect", "fgRadioButtonGroup",
				"fgRadioButton", "fgDateRange", "fgFileUploader"
			];
	...
	function validateControl(oControl, cType) {
		...
		} else if ((cType === "fgSelect" || cType === "fgMobile" || cType === "fgEmail" || cType === "fgNumber" || cType === "fgDate") &&
