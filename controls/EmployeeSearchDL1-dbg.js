sap.ui.define(["jquery.sap.global", "sap/ui/model/Filter", "sap/ui/comp/filterbar/FilterBar", "sap/ui/model/FilterOperator",
	 ...
	 * @param {function} reqestedField Gives the Table model if any
	 * @param {function} fieldId The id of the field
	 * @param {condition} In Mobile screen valuehelpdialog have sap.m.table and in desktop it has sap.ui.table
	 * @param {return} onValueHelpSelection this is the name of the function to be created in the upstream application and first argument will 
	 *					have the data of the selected items in an array
	 * @return {void} 
	 * @public
	 */
	function showValueHelpToDialog(that, f4h) {
		try {
			...
			var modelPathEmployeeSearch = "/sap/opu/odata/sap/ZDD_SH_PERSON_SYBASE_CDS/";
			...
			var filterCurrDate = oDateFormat.format(new Date());
			var sPath = "ZDD_SH_PERSON_sybase('" + filterCurrDate + "')/Set";
			...
			oValueHelpDialog.getTableAsync().then(function (oTable) {
				var sPath = "/ZDD_SH_PERSON";
				var modelPath = "/sap/opu/odata/sap/ZDD_SH_PERSON_SYBASE_CDS/";
				...
				//template is added at the valuehelprequest function at the time of filtering of data
	...
	function onValueHelpRequest(oFilter, that) {
		try {
			...
			var filterCurrDate = oDateFormat.format(new Date());
			var sPath = "/ZDD_SH_PERSON_sybase('" + filterCurrDate + "')/Set";
			//	var sPath = "/ZDD_SH_PERSON_sybase(p_keydate='20191024')/Set";
	...
	function getFilterbar(oValueHelpDialog) {
		try {
			...
			var modelPath = "/sap/opu/odata/sap/ZGEOM_C_ORG_VALUEHELP_CDS/";
			var sPath = "/ZDD_SH_PERSON_sybase('" + filterCurrDate + "')/Set";
			var oFilterBar = new sap.ui.comp.filterbar.FilterBar({
				...
				filterGroupItems: [
					...
					getFilterItem("empGrp", "gn1", "n1", "Personnel number", "searchInput1", "Enter personnel number", sPath,
						"{valueHelpModel>pernr}",
						"{valueHelpModel>pernr}", "valueHelpModel", 3),
					getFilterItem("empGrp", "gn1", "n2", "Employee name", "searchInput2", "Enter employee name", sPath,
						"{valueHelpModel>ename}", "{valueHelpModel>ename}", "valueHelpModel", 3),
					getFilterItem("empGrp", "gn1", "n5", "Email id", "searchInput5", "Enter email id", sPath,
